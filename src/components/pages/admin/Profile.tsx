...
const Profile = () => {
    ...
    const [errorMessage, setErrorMessagel] = useState({incorrectPasswordOrEmail: false, incorrectCode: false, incorrectNewPassword: false, LengthNotEnough: false})
            ...
            {showCodeInput ? passworldVerifyCodeShow() : 
              createNewPassword  ? (
                ...
                <div style={{margin: "10px"}}>
                  ...
                  <br />
                  <br />
                  <input type="password" value={checkNewPassword}  onChange={e => setCheckNewPassword(e.target.value)} placeholder="new password"/>
                  <br /><br />
                  {errortNewPassword()}
                  {notLengthEnough()}
                  <button type='button' className="btn btn-success" style={{marginTop: "10px"}} onClick={async () => {
